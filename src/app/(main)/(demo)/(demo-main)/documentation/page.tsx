...
`}</code>
          ...
          <p>
            ...
            the pages with full page content such as landing page or a login
            page.
          </p>
...
`}
          ...
          <p>
            ...
            under the{' '}
            <span className="text-primary font-medium">app/(demo-main)/</span>{' '}
            folder. Those pages use the{' '}
            <span className="text-primary font-medium">
              app/(demo-main)/layout.tsx
            </span>{' '}
            as the root layout.
          </p>
          <pre className="app-code">
...
`}
          ...
          <p>
            Only the pages that are using config sidebar wihout layout elements
            need to be defined under the{' '}
            <span className="text-primary font-medium">
              app/(demo-full-page)/
            </span>{' '}
            folder. Those pages use the{' '}
            <span className="text-primary font-medium">
              app/(demo-full-page)/layout.tsx
            </span>{' '}
            as the root layout.
          </p>
          <pre className="app-code">
    ...
    const [layoutConfig, setLayoutConfig] = useState({
        ...
        scale: 14                               //size of the body font size to scale the whole application
          ...
          <p>
            ...
            <b>_variables.scss</b> file under layout folder. Saving the changes
